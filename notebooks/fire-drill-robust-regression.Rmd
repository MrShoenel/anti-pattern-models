...
Table \ref{tab:nnet-best-model} also shows whether the generalization error is normally distributed [@royston1982], which it is in many cases (and in some almost).
...
In other words, the a neural network trained on $17$ instances will deliver predictions with a probability of $\approx68$% that are off by $\leq1$.
