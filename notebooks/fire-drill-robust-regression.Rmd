...
if (interactive()) {
  ...
  knitr::kable(
    ...
    booktabs = TRUE,
    caption = "Normality test and p-value, mean, median, standard deviation, min, and max of the RMSE validation error, for the neural network model, using the source code data, amount- and divergence-features, and no PCA. The error reduces steadily with the number of training instances.",
