...
if (interactive()) {
  ...
  knitr::kable(
    x = temp,
    booktabs = TRUE,
    caption = "Mean, median, standard deviation, min, and max of the validation error, grouped by the type of data (it=issue-tracking, sc=source code) conditionally applying PCA for feature set \"both\".",
...
if (interactive()) {
  ...
  knitr::kable(
    ...
    booktabs = TRUE,
    caption = "Normality test and p-value, mean, median, standard deviation, min, and max of the validation error, for the neural network model, using the source code data, amount- and divergence-features, and no PCA. The error reduces steadily with the number of training instances.",
