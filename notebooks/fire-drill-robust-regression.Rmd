...
Using the ground truth, we can now produce a mixture using the projects' weights.
...
Corrective and perfective activities steadily increase and peak towards the end.
...
Let's also try unsupervised learning: Clustering of similar projects.
