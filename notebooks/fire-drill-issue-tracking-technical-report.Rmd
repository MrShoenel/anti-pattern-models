...
loadResultsOrCompute(file = "../results/project_signals_it.rds", computeExpr = {
  all_signals
})
```
...
loadResultsOrCompute(file = "../results/pattern_I_it.rds", computeExpr = {
  pattern_it
})
```
...
loadResultsOrCompute(file = "../results/project_signals_2nd_batch_it.rds", computeExpr = {
