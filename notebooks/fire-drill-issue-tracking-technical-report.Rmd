...
The angle between the projected (predicted) `DEV`-variable of project 5 and the average direction of steepest increase in confidence is $\approx$`r round(matlib::angle(c(.1, fch_mean(0.75) - fch_mean(0.65)),  c(ed_tc_x, ed_tc_y)), 2)``$^{\circ}$.
