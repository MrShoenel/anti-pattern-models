...
loadResultsOrCompute(file = "../data/CI_p3avg_funcs.rds", computeExpr = {
list(
...
What we will do here, is to load the data into a table so that we can produce nice figures for the paper.
