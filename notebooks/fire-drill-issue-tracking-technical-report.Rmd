...
barplot(temp.seg, main = "Average importance per segment (derivative)")
grid()
...
barplot(temp.var, main = "Average importance per variable (derivative)")
grid()
...
barplot(temp.metric, main = "Average importance per metric (derivative)")
grid()
```
