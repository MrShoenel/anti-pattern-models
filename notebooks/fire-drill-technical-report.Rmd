...
This is the complementary technical report for the paper/article tentatively entitled "Towards Data-Based Detection of Project Management Anti-Patterns". Here, we import the ground truth as well as all projects' data, and instantiate our model based on _self-regularizing Boundary Time Warping and Boundary Amplitude Warping_. Given a few patterns that represent the __Fire Drill__ anti-pattern (AP), the goal is evaluate these patterns and their aptitude for detecting the AP in concordance with the ground truth.
...
```{r echo=FALSE}
tikzDevice::tikz(file = "../figures/pattern-I.tex", width = 3.4, height = 2.1)
plot_project_data(data = fd_data_concat, boundaries = fd_data_boundaries) +
