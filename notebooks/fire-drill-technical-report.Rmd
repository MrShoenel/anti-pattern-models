...
```{r p3-avg-no-var-imp-plot, warning=FALSE, echo=FALSE, fig.cap="Plot of the relative variable importances of scores as computed against pattern III (average).", fig.align="top", fig.pos="ht!"}
plot(imp)
```
