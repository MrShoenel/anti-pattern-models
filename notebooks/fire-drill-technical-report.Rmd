...
```{r echo=FALSE}
temp <- cbind(ac_weight_grid, data.frame(weight = ac_sc_weights_pm_I$par))
...
```{r ac-sc-weights-detailed-plot-counts, echo=FALSE, fig.height=5.5, fig.cap="Number of score usages per segment, variable, and metric for process model type I."}
