...
Now we are ready to select a sub-model for each variable in each interval. Note that all sub-models, as well as the objective function are defined in the file `models.R`.
...
### Definition of 2nd stages we use
...
### Definition of list of Sub-models
