...
The main purpose of `srBTAW` is to encapsulate all available data (variables) and intervals, and to provide also helper methods (factories) for creating losses. It will also allow us to reuse instances or `SRBTW` and `SRBAW`/`SRBTWBAW`, as any of these create a tuple of one WP and one WC.
