...
```{r echo=FALSE}
# Currently disabled:
# temp <- YTransRegularization$new(wpName = sig_wp_mlm$getName(), wcName = sig_wc_mlm$getName(), intervals = 1:4, weight = .05, use = "trapezoid")
# mlm$addLoss(loss = temp)
# mlm_obj$setObjective(name = "Loss_vty", obj = temp)

# temp <- TimeWarpRegularization$new(wpName = sig_wp_mlm$getName(), wcName = sig_wc_mlm$getName(), intervals = 1:4, weight = .1, use = "exint")
# mlm$addLoss(loss = temp)
