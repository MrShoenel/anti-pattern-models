...
It is important to create a fully-expanded version of the model $m_q^c$, to better understand its gradient later. Fully expanded, the model $m_q^c$ is given as:
