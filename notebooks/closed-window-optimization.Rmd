...
This is still using the Jenson-Shannon divergence, and apparently it is a better fit. The black vertical lines indicate the used begin and end of the Warping Candidate, and `M` was sliced and layed over `WP`. The begin and end were `r range(tail(cow_og1_test4p$par, 2))`.
