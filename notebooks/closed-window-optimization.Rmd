...
In practice, each weight is some combination of multiple other weights, in our case it will most likely be the product of the weights for the current data series, variable and interval. Back to our example that captures only the __A__-variable, let's set up this scenario with the new classes:
