...
\begin{aligned}
  ...
  \\[1ex]
  t_q(a,x,\dots)=&\;a_q(x-\rho_q)+v+\phi_q^{(y)}\;\text{, linear amplitude warping in}\;q\text{-th interval.}
\end{aligned}
$$
...
\begin{aligned}
  ...
  \\[1ex]
  t_q(a,x,\dots)=&\;a_q(x-\rho_q)+v+\phi_q^{(y)}
  \\[1ex]
  n_q(x,\dots)=&\;f(x,\dots)+\overbrace{a_q(x-\rho_q)+v+\phi_q^{(y)}}^{t_q(a,x,\dots)}\;\text{, sub-model that adds amplitude-warping to}\;f(x,\dots)\text{,}
  \\[1ex]
...
baw_v <- .1
baw_vartheta_y <- c(.05, -.35, -.1, .2, .025)
