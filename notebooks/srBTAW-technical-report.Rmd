...
__ATTENTION__: I had previously fixed an error in the model formulation, so that large parts of this subsection are unfortunately outdated. While some parts are still correct, some are not!
