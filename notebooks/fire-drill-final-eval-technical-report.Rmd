...
```{r echo=FALSE, eval=FALSE}
saveTikzExpr(name = "model_t1_comb", height = 3.5, expr = plotexpr, width = 3.4876)
```
...
```{r}
# 806:323
tikzDevice::tikz(file = paste0("../figures/fig_fdfe_", "corr-all-it", ".tex"), width = FIG_WIDTH, verbose = FALSE, height = 2.7)
eval(plotexpr)
dev.off()
