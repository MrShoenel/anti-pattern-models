...
plotexpr <- expression({
  ...
  corrplot::corrplot(corr = temp, type = "upper", tl.col = "black", tl.srt = 90,
                     col = colorRampPalette(c("#0037AA", "#eeeeee", "#AA0037"))(100))
})
...
```{r}
tikzDevice::tikz("../figures/reproduction/rq1_corr_it.tex", width = 0.5 * FIG_WIDTH, height = 3.5)
eval(plotexpr)
dev.off()
```
...
```{r eval=interactive(), echo=FALSE}
tikzDevice::tikz("../figures/reproduction/rq1_corr_sc.tex", width = 0.5 * FIG_WIDTH, height = 3.5)
eval(plotexpr)
dev.off()
```
...
```
```{r eval=interactive(), echo=FALSE}
tikzDevice::tikz("../figures/reproduction/rq1_corr_all.tex", width = FIG_WIDTH, height = 2.3)
eval(plotexpr)
dev.off()
```
