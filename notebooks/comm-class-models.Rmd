...
Let's load the data we extracted using _Git-Tools_ from the Angular repository (begin 2020 - now). After loading, we will predict the maintenance activity and save the file.
